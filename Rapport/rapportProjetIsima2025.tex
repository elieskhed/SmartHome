...
\begin{document}
	...
	Afin de faciliter l'accès aux données, d'éviter une exposition directe du broker MQTT et aussi de permettre par la suite la création d'interfaces fonctionnant sur divers plateformes, nous avons concu une \textbf{API Rest sous laravel}, jouant deux rôles importants:\\
	\begin{itemize}
		\item \textbf{API de relais:}
	\end{itemize}
